package com.efleets.cloud.employee.legacy.users.client;

import com.efleets.cloud.legacy.users.client.jaxb.*;
	...
	public DeleteUserResponse deleteUser(long id) {
		...
		DeleteUserResponse response = (DeleteUserResponse) getWebServiceTemplate()
				.marshalSendAndReceive("http://localhost:8060/cloud-demo/ws", 
						request,
						new SoapActionCallback("http://efleets.com/cloud/schema/UserPort/deleteUserRequest"));
