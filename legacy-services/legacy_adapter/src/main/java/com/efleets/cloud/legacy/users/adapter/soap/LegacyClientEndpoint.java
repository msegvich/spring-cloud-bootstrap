package com.efleets.cloud.legacy.users.adapter.soap;

import static com.efleets.cloud.legacy.users.adapter.soap.Constants.NAMESPACE_URI;
...
import com.efleets.cloud.legacy.users.adapter.services.AdapterService;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.CreateUserRequest;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.CreateUserResponse;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.DeleteUserRequest;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.DeleteUserResponse;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.FindAllRequest;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.FindAllResponse;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.FindUserRequest;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.FindUserResponse;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.RS;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.UpdateUserRequest;
import com.efleets.cloud.legacy.users.adapter.soap.jaxb.UpdateUserResponse;
